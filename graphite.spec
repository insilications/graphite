...
Version  : 1.3.14
Release  : 11
URL      : file:///insilications/build/clearlinux/packages/graphite/graphite-1.3.14.tar.gz
Source0  : file:///insilications/build/clearlinux/packages/graphite/graphite-1.3.14.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599679665
mkdir -p clr-build
pushd clr-build
